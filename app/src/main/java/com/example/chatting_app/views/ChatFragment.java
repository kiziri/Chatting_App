...
import com.example.chatting_app.models.ExitMessage;
import com.example.chatting_app.models.Message;
import com.example.chatting_app.models.Notification;
...
public class ChatFragment extends Fragment {
    ...
    private void addChatListener() {
        mChatRef.addChildEventListener(new ChildEventListener() {
            ...
            @Override
            public void onChildChanged(final DataSnapshot chatDataSnapshot, @Nullable String s) {
                // 변경된 방의 정보 수신
                ...
                if (updatedChat.getLastMessage() != null ) {
                    ...
                    if ( !updatedChat.getLastMessage().getMessageUser().getUid().equals(fUser.getUid())) {
    ...
    public void leaveChat(final Chat chat) {
        final DatabaseReference messageRef = mDatabase.getReference("chat_messages").child(chat.getChatId());
            ...
            public void onClick(View view) {
                ...
                mChatRef.child(chat.getChatId()).removeValue(new DatabaseReference.CompletionListener() {
                    ...
                    public void onComplete(DatabaseError databaseError, DatabaseReference chatRef) {
                        ...
                        exitMessage.setMessageUser(new User(fUser.getUid(), fUser.getEmail(), fUser.getDisplayName(), fUser.getPhotoUrl().toString()));
                        ...
                        mChatMemberRef
                                ...
                                .removeValue(new DatabaseReference.CompletionListener() {
                                    ...
                                    public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                                                ...
                                                .addListenerForSingleValueEvent(new ValueEventListener() {
                                                    ...
                                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                                        ...
                                                        while (chatMemberIterator.hasNext()) {
                                                            ...
                                                            // chats -> {uid} -> {chat_id} - { ... }
                                                            mDatabase.getReference("Users").child(chatMember.getUid()).child("chats").child(chat.getChatId()).child("lastMessage").setValue(exitMessage);
                                                        }
                                                    }
                                        ...
                                        mDatabase.getReference("messages").child(chat.getChatId()).addListenerForSingleValueEvent(new ValueEventListener() {
                                            @Override
                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                ...
                                                while (messageIterator.hasNext()) {
                                                    ...
                                                    if (!currentMessage.getReadUserList().contains(fUser.getUid())) {
                                                        // message
